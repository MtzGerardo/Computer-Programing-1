...
class MainForm(Form):
	...
	def TimerballTick(self, sender, e):
		...
		if ball.Location.X >= self.Width or (ball.Location.X > rpdl.Right + 20 and ball.Location.Y > rpbl.Top):
			lscore += 1
			ball.Left = self.Width // 2
			ball.Top = self.Height // 2
	...
	def MainFormLoad(self, sender, e):
		""" TODO: ADD 3 UNIQUE SECRETS/CHEATS/EASTER EGGS IN TOTAL AND FINISH MULITPLAYER AND SCOREBOARD AND DUMMY AI"""
		self.balld = 1
		self.ballup = self.R.Next(-4, 5)
		self._timerball.Enabled = False
